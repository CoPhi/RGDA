...
//		}
	...
	public String greekclick(){
		...
		System.out.println("selected pericope: " + selectedPericope.getGreekText().getContent());
		return "";
	}
	...
	public String arabicclick(){
		...
		System.out.println("selected pericope: " + selectedPericope.getArabicText().getContent());
		return "";
	}
