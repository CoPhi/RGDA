...
public class ManagerBean implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7595218418034699956L;
...
//	private CommentSet commentSet;
	...
	public void viewAnalysisAr(){
		...
		for (Pericope pericope : pericopes) {
			try{
			System.out.print(
					pericope.getArabicText().getAnalysis().getAnalysis().get(0).getForm().getValue());
			System.out.println(": "+pericope.getArabicText().getContent());
			}catch(Exception ex){
				//
			}
		}
	...
	public void viewAnalysisGr(){
		...
		for (Pericope pericope : pericopes) {
			...
			System.out.print( "(1)" +
					pericope.getGreekText().getAnalysis().getAnalysis().get(lenght-1).getForm().getValue());
			System.out.println("["+lenght+"]: "+ pericope.getGreekText().getContent());
			}catch(Exception ex){
				//
			}
		}
